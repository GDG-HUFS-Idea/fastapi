    ...
    def _generate_domestic_market_research_prompt(
        ...
        return dedent(
            ...
            {{
                ...
                "marketSizeByYear": [
                    {{"year": 2020, "size": "숫자만 입력(단위 없이, 예: 10000000)", "growthRate": "숫자만 입력(%, 기호 없이)"}},
                    {{"year": 2021, "size": "숫자만 입력(단위 없이, 예: 10000000)", "growthRate": "숫자만 입력(%, 기호 없이)"}},
                    {{"year": 2022, "size": "숫자만 입력(단위 없이, 예: 10000000)", "growthRate": "숫자만 입력(%, 기호 없이)"}},
                    {{"year": 2023, "size": "숫자만 입력(단위 없이, 예: 10000000)", "growthRate": "숫자만 입력(%, 기호 없이)"}},
                    {{"year": 2024, "size": "숫자만 입력(단위 없이, 예: 10000000)", "growthRate": "숫자만 입력(%, 기호 없이)"}},
                    {{"year": 2025, "size": "숫자만 입력(단위 없이, 예: 10000000)(예상)", "growthRate": "숫자만 입력(%, 기호 없이)"}}
                ],
                "averageRevenue": "숫자만 입력(단위 없이, 예: 10000000)",
